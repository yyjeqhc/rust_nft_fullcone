...
enum {
	NFTNL_EXPR_RCONE_FLAGS		= NFTNL_EXPR_BASE,
	NFTNL_EXPR_RCONE_REG_PROTO_MIN,
	NFTNL_EXPR_RCONE_REG_PROTO_MAX,
	__NFTNL_EXPR_RCONE_MAX
};
enum {
	NFTNL_EXPR_PRCONE_FLAGS		= NFTNL_EXPR_BASE,
	NFTNL_EXPR_PRCONE_REG_PROTO_MIN,
	NFTNL_EXPR_PRCONE_REG_PROTO_MAX,
	__NFTNL_EXPR_PRCONE_MAX
};
