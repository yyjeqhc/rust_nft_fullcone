...
%type <stmt>			nat_stmt nat_stmt_alloc masq_stmt masq_stmt_alloc fullcone_stmt fullcone_stmt_alloc rcone_stmt rcone_stmt_alloc prcone_stmt prcone_stmt_alloc redir_stmt redir_stmt_alloc
%destructor { stmt_free($$); }	nat_stmt nat_stmt_alloc masq_stmt masq_stmt_alloc fullcone_stmt fullcone_stmt_alloc rcone_stmt rcone_stmt_alloc prcone_stmt prcone_stmt_alloc redir_stmt redir_stmt_alloc
...
stmt			:	verdict_stmt
			...
			|	rcone_stmt	close_scope_nat
			|	prcone_stmt	close_scope_nat
...
rcone_stmt		:	rcone_stmt_alloc		rcone_stmt_args
			|	rcone_stmt_alloc
			;

rcone_stmt_alloc		:	RCONE	{ $$ = nat_stmt_alloc(&@$, NFT_NAT_RCONE); }
			;

rcone_stmt_args		:	TO 	COLON	stmt_expr
			{
				$<stmt>0->nat.proto = $3;
			}
			|	TO 	COLON	stmt_expr	nf_nat_flags
...
prcone_stmt		:	prcone_stmt_alloc		prcone_stmt_args
			|	prcone_stmt_alloc
			;

prcone_stmt_alloc		:	PRCONE	{ $$ = nat_stmt_alloc(&@$, NFT_NAT_PRCONE); }
			;

prcone_stmt_args		:	TO 	COLON	stmt_expr
			{
				$<stmt>0->nat.proto = $3;
			}
			|	TO 	COLON	stmt_expr	nf_nat_flags
