				 ...
				 const struct stmt *stmt)
{
	...
	case NFT_NAT_FULLCONE:
		...
		break;
	case NFT_NAT_RCONE:
		nle = alloc_nft_expr("rcone");

		nftnl_flag_attr = NFTNL_EXPR_RCONE_FLAGS;
		nftnl_reg_pmin = NFTNL_EXPR_RCONE_REG_PROTO_MIN;
		nftnl_reg_pmax = NFTNL_EXPR_RCONE_REG_PROTO_MAX;
		break;
	case NFT_NAT_PRCONE:
		nle = alloc_nft_expr("prcone");

		nftnl_flag_attr = NFTNL_EXPR_PRCONE_FLAGS;
		nftnl_reg_pmin = NFTNL_EXPR_PRCONE_REG_PROTO_MIN;
		nftnl_reg_pmax = NFTNL_EXPR_PRCONE_REG_PROTO_MAX;
		break;
	case NFT_NAT_REDIR:
